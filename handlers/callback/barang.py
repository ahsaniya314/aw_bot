...
def register(bot):
    ...
    def handle_apply_price(call: CallbackQuery):
        ...
        try:
            ...
            if call.data == "mb_apply_price_all":
                ...
                from core.master_data import format_rupiah, get_all_barang, update_barang
    ...
    @bot.callback_query_handler(
        func=lambda call: call.data.startswith("mb_hapus_")
        and not call.data.startswith("mb_hapus_prep_")
    )
