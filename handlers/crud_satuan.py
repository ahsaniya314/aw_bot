...
from core.master_data import tambah_satuan, update_satuan, get_all_satuan
...
def _ms_terima_nama(message):
    ...
    try:
        ...
        if msg_input_id:
            ...
            safe_edit_message(bot, teks_konfirmasi, chat_id, msg_input_id, parse_mode="HTML", reply_markup=markup_konfirmasi)
        else:
            bot.send_message(chat_id, teks_konfirmasi, parse_mode="HTML", reply_markup=markup_konfirmasi)
