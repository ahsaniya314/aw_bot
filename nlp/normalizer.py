...
def koreksi_teks(teks_kotor, daftar_barang=None):
    ...
    for idx, phrase in enumerate(["belum lunas", "belum bayar", "belum dibayar", "sudah lunas", "sudah bayar"]):
    ...
    if _typo_map or _abbr_map:
        ...
        for w in words_pre:
            ...
            elif w_low in [k.lower() for k in KAMUS_ALIAS.keys()] or w_low in [v.lower() for v in KAMUS_ALIAS.values()]:
                replaced_words.append(w)
                ...
                if res_2:
                    ...
                    if skor_2 >= 90:  # Threshold dinaikkan ke 90 agar tidak "menelan" kata tetangga
                        ...
                        if terbaik_2 in KAMUS_ALIAS:
                            corrected_words.append(terbaik_2 if _preserve_generic_alias(terbaik_2) else KAMUS_ALIAS[terbaik_2])
                        else:
                ...
                if res_1:
                    ...
                    if skor_1 >= 85:
                        ...
                        if terbaik_1 in KAMUS_ALIAS:
                            corrected_words.append(terbaik_1 if _preserve_generic_alias(terbaik_1) else KAMUS_ALIAS[terbaik_1])
                        else:
